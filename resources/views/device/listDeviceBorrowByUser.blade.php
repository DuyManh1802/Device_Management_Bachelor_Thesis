                ...
                <tbody class="table-border-bottom-0">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @elseif ($device->useHistory->status === null)
                        ...
                        <td>
                            ...
                            @else
                            <span class="badge bg-label-info me-1">Đang sửa chữa / bảo hành</span>
                            @endif
                        </td>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item"
                                        ...
                                        onclick="return sendRequest();"><i class="bx bx-edit-alt me-1"></i> Báo hỏng</a>
                                    <a class="dropdown-item"
                                        href="{{ route('request.sendReturnRequest', $device->device->id) }}"
                                        onclick="return sendRequest();"><i class="bx bx-trash me-1"></i>
                                        Trả thiết bị</a>
                                </div>
                            </div>
                        </td>
